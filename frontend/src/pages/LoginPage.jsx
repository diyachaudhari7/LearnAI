      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            Authenticate to resume your adaptive competency session
          </p>
        </div>
        ...
        <Card className="p-6 sm:p-8 space-y-6 shadow-2xl dark:shadow-[0_20px_60px_rgba(0,0,0,0.6),inset_0_1px_0_0_rgba(255,255,255,0.08)]" glass>
          ...
          <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-darkBg/60 border border-slate-200/80 dark:border-white/[0.08] flex items-center justify-between gap-3">
            <div className="text-xs">
              <p className="font-semibold text-slate-900 dark:text-white font-sans">Instant Demo Sandbox</p>
              <p className="font-mono text-[11px] text-slate-500 dark:text-slate-400">Pre-seeded PDFs, quizzes & radar stats</p>
            </div>
            <Button
